...
ILSTR localhost = ILSTR(L"127.0.0.1");
...
//                    typedef uintptr_t(__stdcall * Nexusing)(void* socketmanager);
//                    Connect connect = (Connect)(reinterpret_cast<uintptr_t>(GetModuleHandle("GameAssembly.dll")) + 0x183B400);
//                    connect(_socketmanager, _ip, 2050, _in, _out);

//                    uintptr_t correctAddress =
//                            reinterpret_cast<uintptr_t>(GetModuleHandle("GameAssembly.dll")) + 0x183B400;
